...
/**
 * @author Christian McCann 11/9/2019 This enum is used for all products. each product has a
 * specific type and this enum defines the select few choices for type.
 */
